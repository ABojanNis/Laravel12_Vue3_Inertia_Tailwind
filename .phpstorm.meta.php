...
'app.aliases.Listing','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver','auth.guards.web.provider',
...
'filesystems.disks.s3.url','filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./var/www/public/storage',
...
'debugbar.queries.explain','sanctum.csrf-cookie','ignition.healthCheck','ignition.executeSolution','ignition.updateConfig','listing.index','listing.show',
'listing.offer.store','notification.index','notification.seen','login','login.store',
'logout','verification.notice','verification.send','verification.verify','user-account.create',
'user-account.store','realtor.listing.restore','realtor.listing.index','realtor.listing.create','realtor.listing.store',
'realtor.listing.show','realtor.listing.edit','realtor.listing.update','realtor.listing.destroy','realtor.offer.accept',
